...
const api = {
  ...
  listUnpinnedDefaultDockApps: (): Promise<string[]> => ipcRenderer.invoke('dock:list-unpinned-default-apps'),
  pinDockApp: (app: DockApp): Promise<DockApp[]> => ipcRenderer.invoke('dock:pin-app', app),
  pinDefaultDockApp: (appId: string): Promise<string[]> => ipcRenderer.invoke('dock:pin-default-app', appId),
  unpinDockApp: (appId: string): Promise<DockApp[]> => ipcRenderer.invoke('dock:unpin-app', appId),
  unpinDefaultDockApp: (appId: string): Promise<string[]> => ipcRenderer.invoke('dock:unpin-default-app', appId),
  launchApp: (appId: string): Promise<LaunchResult> => ipcRenderer.invoke('dock:launch-app', appId),
  listQuickLaunches: (): Promise<QuickLaunch[]> => ipcRenderer.invoke('quick-launches:list'),
  createQuickLaunch: (input: CreateQuickLaunchInput): Promise<QuickLaunch[]> => ipcRenderer.invoke('quick-launches:create', input),
  deleteQuickLaunch: (id: string): Promise<QuickLaunch[]> => ipcRenderer.invoke('quick-launches:delete', id),
